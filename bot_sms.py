...
async def sms(ctx, phone, amount:int):
    ...
    if (amount < 151):
      ...
      embes = discord.Embed(title="", description="",color=000000)
      embes.add_field(name="กำลังยิงไปที่เบอร์",value=phone)
      ima = "https://cdn.discordapp.com/attachments/967749428842754068/969540616822349885/2ec4d22394892e53.gif"
      ...
      BBot(phone,amount)
    	...
    	await ctx.channel.send("เอ๋อไรอย่ายิงเกิน 150 โง่")
...
@bot.command()
async def help(ctx):
	emBed = discord.Embed(title="",description="วิธิใช้",color=000000)
	emBed.add_field(name="",value="S2.sms [เบอร์] [จำนวน]")
